...
function popupRegistrar() {
    ...
    <div style="background-color: rgba(0, 0, 0, 0.637); color: white; width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; position: fixed; padding-inline: 0;" id="register">
...
function popupLogin() {
    ...
    <div style="background-color: rgba(0, 0, 0, 0.637); color: white; width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; position: fixed; padding-inline: 0;" id="login">
